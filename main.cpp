...
private:
    ...
    void createInstance()
    {
        ...
        // required struct for telling Vulkan driver which global extensions
        ...
        // Vulkan is platform agnostic, which means you need an extension
        // to interface with the window system.
        // GLFW has a function that returns the extension(s) it needs to do that,
